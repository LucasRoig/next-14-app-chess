...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$GameSourceKind ? _default.$GameSourceKind : 
  T extends _default.$GameResult ? _default.$GameResult : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _default.$GameSourceKind ?
    B extends _default.$GameSourceKind ?
    B
    :
    never
  :
  A extends _default.$GameResult ?
    B extends _default.$GameResult ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::GameSourceKind") {
    if(b.__name__ === "default::GameSourceKind") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::GameResult") {
    if(b.__name__ === "default::GameResult") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
